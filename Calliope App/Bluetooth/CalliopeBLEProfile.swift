...
enum CalliopeService: String, CaseIterable, Codable {
    ...
    ///    uint16 event_value;
    /// };
    case event = "E95D93AF-251D-470A-A062-FA1922DFA9A8"
...
enum CalliopeCharacteristic: String, CaseIterable {
    ...
    case magnetometerData = "E95DFB11-251D-470A-A062-FA1922DFA9A8"
    //frequency with which magnetometer data is reported in milliseconds. Valid values are 1, 2, 5, 10, 20, 80, 160 and 640.
    /// TODO: possible periods do not match with documentation
    case magnetometerPeriod = "E95D386C-251D-470A-A062-FA1922DFA9A8"
    /// Compass bearing in degrees from North.
    case magnetometerBearing = "E95D9715-251D-470A-A062-FA1922DFA9A8"
    ...
    case buttonAState = "E95DDA90-251D-470A-A062-FA1922DFA9A8"
    ...
    case buttonBState = "E95DDA91-251D-470A-A062-FA1922DFA9A8"
    ...
    /// TODO: documentation mismatch: documentation says uint24, but implementation seems to demand uint32
    case pinIOConfiguration = "E95DB9FE-251D-470A-A062-FA1922DFA9A8"
    ...
    case pwmControl = "E95DD822-251D-470A-A062-FA1922DFA9A8"
    ...
    case ledMatrixState = "E95D7B77-251D-470A-A062-FA1922DFA9A8"
    /// A short UTF-8 string to be shown on the LED display. Maximum length 20 octets.
    case ledText = "E95D93EE-251D-470A-A062-FA1922DFA9A8"
    ...
    case temperaturePeriod = "E95D1B25-251D-470A-A062-FA1922DFA9A8"
...
struct CalliopeBLEProfile {
    ...
    static let characteristicServiceMap = Dictionary(
        serviceCharacteristicMap.flatMap { (key, value) in
            value.map { value in
                (value, key)
            }
        },
