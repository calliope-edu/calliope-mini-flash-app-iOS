...
class CalliopeAPI: BLECalliope {
	...
	static let services: Set<CalliopeService> =
		[.partialFlashing, .microbitUtilityService, .led, .touchPin, .accelerometer, .magnetometer, .uart, .rgbLed, .microphone, .speaker, .brightness, .button, .temperature, .gesture]
	...
	public var buttonAActionNotification: ((BLEDataTypes.ButtonPressAction?) -> ())? {
		get {
			return getNotifyListener(for: .buttonAState)
		}
		set {
			setNotifyListener(for: .buttonAState, newValue)
		}
	}
	...
	public var buttonBActionNotification: ((BLEDataTypes.ButtonPressAction?) -> ())? {
		get {
			return getNotifyListener(for: .buttonBState)
		}
		set {
			setNotifyListener(for: .buttonBState, newValue)
		}
	}
	...
	public var scrollingDelay: UInt16 {
		get {
			return read(.scrollingDelay)!
		}
		set {
			write(newValue, .scrollingDelay)
		}
	}
	...
	public var accelerometerNotification: (((Int16, Int16, Int16)?) -> ())? {
		get {
			return getNotifyListener(for: .accelerometerData)
		}
		set {
			setNotifyListener(for: .accelerometerData, newValue)
		}
	}
	...
	public var accelerometerUpdateFrequency: UInt16? {
		get {
			return read(.accelerometerPeriod)
		}
		set {
			write(newValue, .accelerometerPeriod)
		}
	}
	...
	public var magnetometerNotification: (((Int16, Int16, Int16)?) -> ())? {
		get {
			return getNotifyListener(for: .magnetometerData)
		}
		set {
			setNotifyListener(for: .magnetometerData, newValue)
		}
	}
	...
	public var magnetometerUpdateFrequency: UInt16? {
		get {
			return read(.magnetometerPeriod)
		}
		set {
			write(newValue, .magnetometerPeriod)
		}
	}
	...
	public var magnetometerBearingNotification: ((Int16?) -> ())? {
		get {
			return getNotifyListener(for: .magnetometerBearing)
		}
		set {
			setNotifyListener(for: .magnetometerBearing, newValue)
		}
	}
	...
	public var eventNotification: (((BLEDataTypes.EventSource, BLEDataTypes.EventValue)?) -> ())? {
		get {
			return getNotifyListener(for: .microBitEvent)
		}
		set {
			setNotifyListener(for: .microBitEvent, newValue)
		}
	}

	/// temperature reading in celsius
	public var temperature: Int8? {
		guard let temperature: Int8? = read(.temperature) else {
			return nil
		}
		return temperature
	}
	...
	public var temperatureNotification: ((Int8?) -> ())? {
		get {
			return getNotifyListener(for: .temperature)
		}
		set {
			setNotifyListener(for: .temperature, newValue)
		}
	}
	...
	var temperatureUpdateFrequency: UInt16? {
		set {
			write(newValue, .temperaturePeriod)
		}
		get {
			return read(.temperaturePeriod)
		}
	}
	...
	public var uartValueNotification: ((String) -> ())? {
		get {
			return getNotifyListener(for: .uartCharacteristic)
		}
		set {
			setNotifyListener(for: .uartCharacteristic, newValue)
		}
	}
	...
	public var noiseLevel: Int32? {
		guard let level: Int32 = read(.noise) else {
			return nil
		}
		return level
	}
	...
	public var brightness: UInt8? {
		guard let light: UInt8 = read(.brightness) else {
			return nil
		}
		return light
	}
	...
	public var touchPin0Action: BLEDataTypes.ButtonPressAction {
		guard let state: (UInt8, BLEDataTypes.ButtonPressAction) = read(.touchPin) else {
			return .Up
		}
	...
	public var touchPinNotification: (((UInt8, BLEDataTypes.ButtonPressAction)?) -> ())? {
		get {
			return getNotifyListener(for: .touchPin)
		}
		set {
			setNotifyListener(for: .touchPin, newValue)
		}
	}

	public var gestureNotification: ((BLEDataTypes.AccelerometerGesture?) -> ())? {
		get {
			return getNotifyListener(for: .gesture)
		}
		set {
			setNotifyListener(for: .gesture, newValue)
		}
	}
	...
	private var pinDataNotification: (([UInt8: UInt8]?) -> ())? {
		set {
			setNotifyListener(for: .pinData, newValue)
		}
		get {
			return getNotifyListener(for: .pinData)
		}
	}
	...
	private var pinADConfiguration: [BLEDataTypes.PinConfiguration]? {
		get {
			return read(.pinADConfiguration)
		}
		set {
			write(newValue, .pinADConfiguration)
		}
	}
	...
	private var pinIOConfiguration: [Bool]? {
		get {
			return read(.pinIOConfiguration)
		}
		set {
			write(newValue, .pinIOConfiguration)
		}
	}
	...
	func notifyListener(for characteristic: CalliopeCharacteristic, value: Data) {
		...
		case .buttonAState:
			guard let buttonAAction: BLEDataTypes.ButtonPressAction = characteristic.interpret(dataBytes: value) else {
				return
			}
		...
		case .buttonBState:
			guard let buttonBAction: BLEDataTypes.ButtonPressAction = characteristic.interpret(dataBytes: value) else {
				return
			}
		...
		case .touchPin:
			guard let state: (UInt8, BLEDataTypes.ButtonPressAction) = characteristic.interpret(dataBytes: value) else {
				return
			}
			touchPinNotification?(state)
		case .gesture:
			guard let gesture: BLEDataTypes.AccelerometerGesture = characteristic.interpret(dataBytes: value) else {
				return
			}
...
extension CalliopeCharacteristic {
	fileprivate func interpret<T>(dataBytes: Data?) -> T? {
		...
		case .pinADConfiguration, .pinIOConfiguration:
			let config = Array(data.flatMap { (byte) -> [Bool] in
				(0..<8).map { offset in
					(byte & (1 << offset)) == 0 ? false : true
				}
			}
							   .prefix(19))
			if self == .pinADConfiguration {
				return config.map { b -> BLEDataTypes.PinConfiguration in
					b ? .Digital : .Analogue
				} as? T
			}
	...
	fileprivate func encode<T>(object: T) -> Data? {
		switch self {
		case .accelerometerPeriod, .magnetometerPeriod, .temperaturePeriod:
			guard let period = object as? UInt16 else {
				return nil
			}
			return period.littleEndianData
		case .pinData:
			guard let pinValues = object as? [UInt8: UInt8] else {
				return nil
			}
			return Data(pinValues.flatMap {
				[$0, $1]
			})
		case .pinADConfiguration, .pinIOConfiguration:
			let obj: [Int32]?
			if self == .pinADConfiguration {
				obj = (object as? [BLEDataTypes.PinConfiguration])?.enumerated().map {
					$0.element == .Analogue ? (1 << $0.offset) : 0
				}
			} else {
				obj = (object as? [Bool])?.enumerated().map {
					$0.element ? (1 << $0.offset) : 0
				}
			}
			guard var asBitmap = (obj?.reduce(0) {
				$0 | $1
			})
			else {
				return nil
		...
		case .ledMatrixState:
			guard let ledArray = object as? [[Bool]] else {
				return nil
			}
		...
		case .scrollingDelay:
			guard let delay = object as? UInt16 else {
				return nil
			}
		...
		case .clientRequirements:
			guard let eventTuples = object as? [(BLEDataTypes.EventSource, BLEDataTypes.EventValue)] else {
				return nil
			}
		...
		case .color:
			guard let (r, g, b, a) = object as? (UInt8, UInt8, UInt8, UInt8) else {
				return nil
			}
			return r.littleEndianData + g.littleEndianData + b.littleEndianData + a.littleEndianData
		case .playTone:
			guard let (freq, duration) = object as? (UInt16, UInt16) else {
				return nil
			}
